...
public final class CustomToastBinding implements ViewBinding {
  ...
  private CustomToastBinding(@NonNull LinearLayout rootView, @NonNull ImageView toastIcon,
  ...
  public static CustomToastBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CustomToastBinding((LinearLayout) rootView, toastIcon, toastText);
    }
